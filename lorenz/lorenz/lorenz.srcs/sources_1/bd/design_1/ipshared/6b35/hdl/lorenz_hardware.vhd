...
architecture structural of lorenz_hardware_subsystem is 
  ...
  signal register14_q_net_x1 : std_logic_vector( 33-1 downto 0 );
  signal addsub5_s_net : std_logic_vector( 33-1 downto 0 );
  ...
  signal register1_q_net : std_logic_vector( 32-1 downto 0 );
  signal cmult2_p_net : std_logic_vector( 32-1 downto 0 );
  signal register16_q_net : std_logic_vector( 33-1 downto 0 );
  signal register17_q_net : std_logic_vector( 33-1 downto 0 );
  signal delay_q_net : std_logic_vector( 32-1 downto 0 );
  signal delay1_q_net : std_logic_vector( 32-1 downto 0 );
  ...
  signal register13_q_net : std_logic_vector( 32-1 downto 0 );
...
begin
  ...
  register13 : entity xil_defaultlib.lorenz_hardware_xlregister 
  generic map (
    d_width => 32,
    init_value => b"00000000000000000000000000000000"
  )
  ...
  register12 : entity xil_defaultlib.lorenz_hardware_xlregister 
  generic map (
    d_width => 32,
    init_value => b"00000000000000000000000000000000"
  )
  ...
  register15 : entity xil_defaultlib.lorenz_hardware_xlregister 
  generic map (
    d_width => 32,
    init_value => b"00000000000000000000000000000000"
  )
  ...
  register16 : entity xil_defaultlib.lorenz_hardware_xlregister 
  generic map (
    d_width => 33,
    init_value => b"000000000000000000000000000000000"
  )
  ...
  register17 : entity xil_defaultlib.lorenz_hardware_xlregister 
  generic map (
    d_width => 33,
    init_value => b"000000000000000000000000000000000"
  )
