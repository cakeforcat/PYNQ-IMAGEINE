...
entity lorenz_hardware_bd_wrapper is
  port (
...
architecture STRUCTURE of lorenz_hardware_bd_wrapper is
  component lorenz_hardware_bd is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
begin
lorenz_hardware_bd_i: component lorenz_hardware_bd
     port map (
